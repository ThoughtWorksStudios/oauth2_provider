...
module Oauth2
  module Provider
    class OauthAuthorizeControllerTest < ActionController::TestCase
      ...
      def teardown
        Oauth2::Provider::OauthAuthorizeController.allow_forgery_protection = false
        Oauth2::Provider::OauthAuthorizeController.request_forgery_protection_token = nil
        Clock.reset
      end
      ...
      def test_index_contains_authenticity_token_field
        Oauth2::Provider::OauthAuthorizeController.allow_forgery_protection = true
        Oauth2::Provider::OauthAuthorizeController.request_forgery_protection_token = 'authenticity_token'
        session[:user_id] = @user.id
