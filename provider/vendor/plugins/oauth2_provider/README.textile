...
Execute the configuration script:
 ...
 $ script/generate script/generate oauth2_provider
...
* In your RAILS_ROOT, run rake db:migrate, this will run all the migrations that were created as when you executed the oauth2_provider generator.
